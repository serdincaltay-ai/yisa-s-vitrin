...
export const FAQ = [
  ...
  },
  {
    ...
    answer: 'Üç paket sunuyoruz: Standart ($3.000/ay, 50 öğrenci, 1.000 tohum), Orta ($5.000/ay, 150 öğrenci, 3.000 tohum), Premium ($8.000/ay, sınırsız öğrenci, 10.000 tohum). Kullanılmayan tohumlar bir sonraki aya devreder.',
  },
  {
    id: 6,
    category: 'Bayilik',
...
## FİYATLANDIRMA
| Paket | Aylık | Öğrenci | Tohum |
|-------|-------|---------|-------|
| Standart | $3.000 | 50 | 1.000/ay |
| Orta | $5.000 | 150 | 3.000/ay |
| Premium | $8.000 | Sınırsız | 10.000/ay |
